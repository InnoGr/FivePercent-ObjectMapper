...
use FivePercent\Component\ObjectMapper\Exception\MapException;
use FivePercent\Component\ObjectMapper\Metadata\CachedMetadataFactory;
...
use FivePercent\Component\ObjectMapper\Metadata\MetadataFactoryInterface;
use FivePercent\Component\ObjectMapper\Metadata\ObjectMetadata;
use FivePercent\Component\ObjectMapper\Exception\ObjectNotSupportedException;
...
use FivePercent\Component\ObjectMapper\Strategy\StrategyManagerInterface;
use FivePercent\Component\Reflection\Reflection;

/**
 * Data mapper with read metadata from object
 *
...
class ObjectMapper implements ObjectMapperInterface
{
     ...
     */
    public function __construct(MetadataFactoryInterface $metadataFactory, StrategyManagerInterface $strategyManager)
    {
